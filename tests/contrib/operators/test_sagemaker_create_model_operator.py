...
from airflow.contrib.operators.sagemaker_create_model_operator \
    import SageMakerCreateModelOperator
...
class TestSageMakerModelOperator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sagemaker = SageMakerCreateModelOperator(
            task_id='test_sagemaker_operator',
            sagemaker_conn_id='sagemaker_test_id',
            model_request=create_model_params,
    ...
    def test_hook_init(self, hook_init, mock_model, mock_client):
    ...
    @mock.patch.object(SageMakerHook, 'get_conn')
    @mock.patch.object(SageMakerHook, 'create_model')
    def test_execute_without_failure(self, mock_model, mock_client):
        mock_model.return_value = {"ModelArn": "testarn",
                                   "ResponseMetadata":
                                       {"HTTPStatusCode": 200}}
        self.sagemaker.execute(None)
